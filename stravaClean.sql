--View top 100 rows of database
SELECT TOP 2000 *
FROM [stravaData].[dbo].[activities6];
...
UPDATE [stravaData].[dbo].[activities6]
...
ALTER TABLE [stravaData].[dbo].[activities6]
...
DELETE FROM [stravaData].[dbo].[activities6]
WHERE [Activity Type] <> 'Run';
